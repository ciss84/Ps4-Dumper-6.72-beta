...
int kpayload_jailbreak(struct thread *td, struct kpayload_jailbreak_args *args) {
  ...
  *sceProcCap = 0xffffffffffffffff;
  ...
  // enable mmap of all SELF 6.72
  *(uint8_t *)(kernel_base + 0x233A00) = 0xB0;
  *(uint8_t *)(kernel_base + 0x233A01) = 0x01;
  *(uint8_t *)(kernel_base + 0x233A02) = 0xC3;
  *(uint8_t *)(kernel_base + 0x233EF9) = 0xB0;
  *(uint8_t *)(kernel_base + 0x233EFA) = 0x01;
  *(uint8_t *)(kernel_base + 0x233EFB) = 0xC3;
   
	*(uint8_t *)(kernel_base + 0x3CBF9D) = 0x31;
	*(uint8_t *)(kernel_base + 0x3CBF9E) = 0xC0;
	*(uint8_t *)(kernel_base + 0x3CBF9F) = 0x90;
	*(uint8_t *)(kernel_base + 0x3CBFA0) = 0x90;
	*(uint8_t *)(kernel_base + 0x3CBFA1) = 0x90;
		
	// debug settings patches 672
	*(char *)(kernel_base + 0x1BD8006) |= 0x14;
	*(char *)(kernel_base + 0x1BD8029) |= 3;
	*(char *)(kernel_base + 0x1BD802A) |= 1;
	*(char *)(kernel_base + 0x1BD8048) |= 1;
			   
	// debug menu error patches 672
	*(uint8_t *)(kernel_base + 0x504A94) = 0;
	*(uint8_t *)(kernel_base + 0x504C77) = 0;
	*(uint8_t *)(kernel_base + 0x507A01) = 0;
	*(uint8_t *)(kernel_base + 0x507B09) = 0;	
	*(uint8_t *)(kernel_base + 0x507BB8) = 0;
	*(uint8_t *)(kernel_base + 0x507ECF) = 0;
	*(uint8_t *)(kernel_base + 0x508D5C) = 0;	
	*(uint8_t *)(kernel_base + 0x510423) = 0;
	*(uint8_t *)(kernel_base + 0x5108E3) = 0;
	*(uint8_t *)(kernel_base + 0x510BFA) = 0;
	*(uint8_t *)(kernel_base + 0x5115E1) = 0;
	*(uint8_t *)(kernel_base + 0x511B4D) = 0;
	*(uint8_t *)(kernel_base + 0x512002) = 0;
	*(uint8_t *)(kernel_base + 0x512191) = 0;
	*(uint8_t *)(kernel_base + 0x5140A8) = 0;
	*(uint8_t *)(kernel_base + 0x514293) = 0;
	*(uint8_t *)(kernel_base + 0x515E71) = 0;
	*(uint8_t *)(kernel_base + 0x515EE7) = 0;
	*(uint8_t *)(kernel_base + 0x515F71) = 0;
	*(uint8_t *)(kernel_base + 0x515F8D) = 0;
	*(uint8_t *)(kernel_base + 0x51F123) = 0;
